...
const quizInfo = {
  puppetPro: {
    title: "Puppet Certified Professional",
    desc: "Puppetのマニフェスト、リソース、モジュール、Hiera、環境管理、運用自動化"
  },
  chefDev: {
    title: "Chef Certified Developer",
    desc: "Chef InfraのCookbook、Recipe、Resource、Test Kitchen、InSpec、Node管理"
  },
  ansibleBadge: {
    title: "Ansible Automation Platform Technical Badge",
    desc: "Ansible Playbook、Inventory、Role、AAP、Automation Controller、実行環境"
  },
  openshiftAdmin: {
    title: "OpenShift Administration",
    desc: "OpenShiftクラスタ管理、プロジェクト、RBAC、ネットワーク、ストレージ、運用監視"
  },
  openshiftDev: {
    title: "OpenShift Application Development",
    desc: "OpenShift上のアプリ開発、BuildConfig、Deployment、Route、S2I、CI/CD"
  }
};
...
if (type === "all") {
  document.title = "構成管理・自動化資格クイズ";
  pageTitle.textContent = "構成管理・自動化資格クイズ";
  pageDesc.textContent = "5カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.puppetPro;
...
questions = uniqueByQuestion(shuffle(questions)).slice(0, QUESTION_LIMIT);
